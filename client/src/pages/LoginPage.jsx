...
const LoginPage = () => {
  ...
  // useState hook to manage the current state of the form, either "Sign up" or "Login"
  ...
  //  useState hooks to manage the input fields for full name, email, and password
  ...
  justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      <img src={assets.logo_big} alt="" className='w-[30vw] max-w-[200px]' />
